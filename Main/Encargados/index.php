<?php
    session_start();
    $IdEncargado =  $_SESSION['userName']["nombre"];
?>
<!DOCTYPE html>
<html lang="en">
  <head>
                            ...
                            <div class="area-prestamo">
                                <div class="formulario">
                                    <div class="form-group">
                                        <form id="formPrestamo" name="formularioPrestamo" method="post" action="imprimeComPrestamo.php">
                                            ...
                                            <button type="button" id=guardaP class="btn btn-stylo" onclick="aceptar()">Aceptar</button> 
                                            <button type="reset" class="btn btn-stylo">Limpiar</button>
                                        </form>                                      
                                    </div>
                                </div>
                                <div id="confirmacion">
                                    <div class="botones">  
                                        <img id="img-Confirmacion" class="iconos-menu" src="../../img/admiracion.png">
                                        <p id="text-Confirmacion" class="prestamo-txt banner-txt"> Revise la información capturada</p>
                                    </div>
                                </div>
                            </div>   
                        </div>
